...
export default function Home() {
  ...
  return <main>
    ...
    <section className="workspace">
      <div className="panel"><SectionTitle number="3" title="読み取った文章" note="直したいところがある場合は、ここで直せます。"/><textarea value={text} onChange={(event) => { setText(event.target.value); setResult(null); }} placeholder="読み取った新聞記事がここに入ります。記事を直接貼り付けても使えます。" maxLength={5000}/><div className="counter">{text.length.toLocaleString()} / 5,000字</div></div>
